...
Thanks for joining <?php echo $site_name; ?>.<br>We listed your sign in details below, make sure you keep them safe.<br />
To verify your email address, please follow this link:<br />
<br />
<big style="font: 23px/26px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;">Click here to finish your registration...</a></b></big><br />
<br />
...
<br />
<br />
<?php if (strlen($username) > 0) { ?>Your username: <strong><?php echo $username; ?></strong><br /><?php } ?>
...
<br>
<img src="<?=base_url();?>images/logo.jpg" height="100" width="100"/>
