<div id="footer-inner">
	<style>
	.footer-logo { width: 280px;float:left;}
	.footer-links { width: 150px; }
	.socialicons { width: 300px;float:right; }
	</style>
		...
		<a href="<?=base_url();?>">
			<div id="logo_text_top" class="logo_text" style="color: #666; text-align: left; margin-left: 25px;">Novus<font color="#888">bit</font> </div>    
		</a>
		                                                                                                                    
		<p>Novusbit relies on a simple idea. Each member starts a story; call it a <strong>Novus</strong>. Other members continue them by writing <strong>Bits</strong> of text. Bit by bit the story gets a new twist!</p>
			</span>
		</div>
		<div class="footer-links">
			<h3>About</h3>
			<ul>
				<li><a href="/about/samplepage" id="f-home"></a></li>
				<li><a href="/about/novus">What's a Novus?</a></li>
				<li><a href="/about/bits">What's a Bit?</a></li>
				<li><a href="/about/types">Novus types</a></li>
				<li><a href="/about/help">Contact</a></li>
			</ul>
		</div>
		<!--
		<div class="footer-links">
			<h3>Community</h3>
			<ul>
				<li><a href="https://www.facebook.com/novusbit">Blog</a></li>
			</ul>
		</div>
		-->
		<div class="socialicons">
			<h3>Connect</h3>
			<ul>
                    	<li><a href="http://fb.com/novusbit"  target="_blank" inject="no">
...
<path d="M28.347,5.157c-13.6,0-24.625,11.027-24.625,24.625c0,13.6,11.025,24.623,24.625,24.623c13.6,0,24.625-11.023,24.625-24.623
	...
	h4.818L34.864,29.679z"/>
                               ...
                               <li><a href="http://twitter.com/novusbit"  target="_blank"  inject="no"><svg style="fill:#00aced;" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="56.693px" height="56.693px" viewBox="0 0 56.693 56.693" enable-background="new 0 0 56.693 56.693" xml:space="preserve">
<path d="M28.348,5.157c-13.6,0-24.625,11.027-24.625,24.625c0,13.6,11.025,24.623,24.625,24.623c13.6,0,24.623-11.023,24.623-24.623
	...
	C43.018,22.849,41.965,23.942,40.752,24.817z"/>
                                ...
                                <li><a href="https://plus.google.com/b/113816458424198246552/113816458424198246552/"  target="_blank"  inject="no"><svg style="fill:#d94a3a;" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="56.693px" height="56.693px" viewBox="0 0 56.693 56.693" enable-background="new 0 0 56.693 56.693" xml:space="preserve">
<g>
	...
	<path d="M28.347,5.157c-13.601,0-24.625,11.023-24.625,24.623s11.025,24.625,24.625,24.625c13.598,0,24.623-11.025,24.623-24.625
		...
		V29.948z"/>
                    ...
                    <div class="fb-like" data-href="http://facebook.com/novusbit" data-send="false" data-width="300" data-show-faces="true" data-font="segoe ui" ></div>
		</div>
	
	<p>Copyright &copy; 2010-2013 Novusbit.com - All bits and Novus &copy; their respective authors.
	
		<a href="http://lancom.gr" class="footer-mt" inject="no" target="_blank">Hosted by Lancom</a>
	</p></div>
