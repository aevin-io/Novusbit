 ...
 $(document).ready(function () {$('#loading').hide();});
	...
	<span style="margin-bottom: 0.5em; line-height: 28px;">
			...
			<input tabindex="4" type="submit" class="button toplogin-submit welcome_button" value="login" id="toplogin-submit" inject="no" style="float:right">
		</span>
	
	
	
	
	<a href="#" id="forgot_pass" inject="no">Forgot password</a>
